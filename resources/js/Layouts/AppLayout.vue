    ...
    <div class="h-full bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
        ...
        <main class="py-10 lg:pl-72">
            <div class="px-4 sm:px-6 lg:px-8 w-full max-w-7xl mx-auto overflow-x-hidden">
                <div v-if="$page.props.flash.success" class="mb-6 rounded-md bg-green-50 dark:bg-green-900/30 p-4 border border-green-200 dark:border-green-800">
                    <div class="flex">
                ...
                <div v-if="$page.props.flash.error" class="mb-6 rounded-md bg-red-50 dark:bg-red-900/30 p-4 border border-red-200 dark:border-red-800">
                    <div class="flex">
                        <div class="flex-shrink-0">
